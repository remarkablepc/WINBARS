...
echo     - Floppy tray icon, ScamBuster watchdog, Protection Center GUI
echo     - Alerts when the backup drive is disconnected
echo.
...
echo   ----------------------------------------------------------------
!RUN_CMD! -SetProfile FullInteractive -Vanilla -Unattended -ConfigPath "!ACTIVE_CONFIG_PATH!"
