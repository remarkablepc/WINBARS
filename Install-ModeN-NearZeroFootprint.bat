...
echo     - Near-zero footprint stealth deployment
echo     - Native Task Scheduler automation, zero resident EXEs
echo     - User data mirrored to the backup drive WindowsBackup folder
echo     - Unbranded desktop shortcuts + Start Menu recovery folder
echo.
...
echo   ----------------------------------------------------------------
!RUN_CMD! -SetProfile NearZeroFootprint -Vanilla -Unattended -ConfigPath "!ACTIVE_CONFIG_PATH!"
