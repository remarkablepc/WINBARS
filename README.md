...
| **Mode N: `NearZeroFootprint`** 👻 | Corporate Clients & Anti-Competitor Stealth | Mode 0 + generic unbranded desktop shortcuts (`Backup Personal Files`, `Windows System Restore`, `Browse Backup Files`) + unbranded Start Menu (`System Backup & Recovery`) | **0 Resident EXEs/Daemons**<br>Automated via native Task Scheduler; restores via standard Explorer, `rstrui.exe`, and WinRE |
