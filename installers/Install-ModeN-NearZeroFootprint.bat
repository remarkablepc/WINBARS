...
title WINBARS One-Click Installer - Mode N (NearZeroFootprint)
:: ============================================================================
::  WINBARS ONE-CLICK INSTALLER - MODE N : NEAR-ZERO FOOTPRINT
::  Applies all Mode N defaults automatically. Asks only 2 questions:
...
echo.
echo ========================================================================
echo   WINBARS ONE-CLICK INSTALLER - MODE N : NEAR-ZERO FOOTPRINT
echo ========================================================================
echo   Near-Zero Footprint (Stealth Native Automation + Shortcuts).
echo.
echo SYNTAX:
echo   Install-ModeN-NearZeroFootprint.bat [/?] [/Quiet] [/Vanilla] [/Brand:Name]
...
echo.
echo EXAMPLES:
echo   Install-ModeN-NearZeroFootprint.bat
echo   Install-ModeN-NearZeroFootprint.bat /Data:D /Image:D /Baseline:Y /Quiet
echo   Install-ModeN-NearZeroFootprint.bat /Brand:RemarkablePC /Quiet
echo ========================================================================
echo.
exit /b 0
...
echo   WINBARS ONE-CLICK INSTALLER - MODE N : NEAR-ZERO FOOTPRINT
echo ================================================================
echo   What Mode N does:
echo     - Near-Zero footprint on PC (hardened native Windows automation)
echo     - Desktop/Start shortcuts created for user manual controls
echo     - Daily restore points + personal file mirror to backup drive
echo     - Bare-metal system images + BitLocker key archival
echo.
...
echo.
echo   Applying Mode N NearZeroFootprint defaults and scheduling tasks...
echo   ----------------------------------------------------------------
set "EXTRA_FLAGS="
...
!RUN_CMD! -SetProfile NearZeroFootprint !BRAND_FLAG! -Unattended -ConfigPath "!ACTIVE_CONFIG_PATH!" !EXTRA_FLAGS!
set "PROFILE_EXIT=!errorLevel!"
echo   ----------------------------------------------------------------
if !PROFILE_EXIT! EQU 0 (
    echo   [OK] Mode N NearZeroFootprint profile applied successfully.
) else (
